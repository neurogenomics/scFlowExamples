#' Zeisel 2018 dataset for TEINH15, TEINH19, MGL1, MOL1 cells
#'
...
#' Downsampled cells Zeisel 2018 dataset for TEINH15, TEINH19, MGL1, MOL1 cells
#'
#' See link: http://mousebrain.org/celltypes/
#'
#' @source
...
#' Downsampled cells and genes Zeisel 2018 dataset for TEINH15, TEINH19, MGL1, MOL1 cells
#'
#' See link: http://mousebrain.org/celltypes/
#'
#' @source
